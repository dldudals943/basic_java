...
public class ExceptionHandling {
	public static void main(String[] args) {
		...
		}catch(ArithmeticException | IndexOutOfBoundsException e){ // 여러 오류를 받기 위해서는 이렇게 추가하거나
			e.printStackTrace();
		}catch(NullPointerException e){ // 캐치를 여러번하거나
			
		}catch(Exception e){ // 최상위 클래스인 Exception 클래스로 받는다. 보통 예외처리는 형식적인 경우가 많다.
