...
public class StringClass {
	...
	public static void main(String[] args) {
		...
		//System.out.println(str2.equals(str1)); //앞에 있는 변수에 null이 들어가면 안 됨
		...
		str = "0123456789";
		String str3 = str.substring(3);//3번 인덱스부터 잘라서 반환한다.
		System.out.println(str3);
		String str4 = str.substring(5,8);//5번 인덱스부터 8번 인덱스 전까지 잘라서 반환한다.
